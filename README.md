...
```json
{
  ...
  "endpoints": [
    {
      "name": "A2A",
      "endpoint": "https://docsummary.updev.si/summarize-doc",
      "version": "1.0"
    },
    {
      "name": "agentWallet",
...
**Live service running on Oasis Testnet** at **https://docsummary.updev.si** ([App ID: `rofl1qq6m08wlj3qawcfrd3ljyge2t0praed5ycwh7upg`](https://explorer.oasis.io/testnet/sapphire/rofl/app/rofl1qq6m08wlj3qawcfrd3ljyge2t0praed5ycwh7upg))

Test the live deployment:

```bash
cd test
echo "API_URL=https://docsummary.updev.si" >> .env
